@echo off
echo ========================================
echo    EventApp - Full App (Port 3000)
echo ========================================
echo.
...
echo [2/2] Starting Full EventApp on port 3000...
echo.
...
echo.
echo ========================================
echo   Starting Full EventApp on port 3000...
echo   Press Ctrl+C to stop the server
echo ========================================
echo.

:: Start the full EventApp on port 3000
