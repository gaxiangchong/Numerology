@echo off
echo ========================================
echo    EventApp - Fixed PWA Version
echo ========================================
echo.
...
echo [2/2] Starting Fixed EventApp PWA...
echo.
...
echo - No database conflicts
echo - User registration/login
echo - Offline functionality
echo.
echo ========================================
echo   Starting Fixed EventApp PWA...
echo   Press Ctrl+C to stop the server
echo ========================================
echo.

:: Start the fixed PWA app
python working_pwa_app_fixed.py
