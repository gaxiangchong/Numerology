...
echo [3/3] Starting EventApp on port 8080...
echo.
echo ========================================
echo   EventApp is starting on port 8080...
echo ========================================
echo.
