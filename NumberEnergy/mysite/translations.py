...
TRANSLATIONS = {
    'en': {
        ...
        'starter_badge': 'Best for beginner',
        
        # Buttons and actions
        'btn_analyze': 'Analyze',
        'btn_analyze_with_credits': 'Analyze (2 credits)',
        'btn_analyzing': 'Analyzing...',
        'btn_login': 'Login',
        'forgot_password': 'Forgot password?',
        'forgot_password_title': 'Reset Password',
        'login_tab_password': 'Password',
        'login_tab_otp': 'WhatsApp OTP',
        'login_otp_description': 'Get a one-time code via WhatsApp so you don’t need to remember your password.',
        'login_otp_phone_label': 'Phone (for OTP)',
        'login_otp_phone_hint': 'E.g. +60 12 345 6789. OTP will be sent to this number via WhatsApp.',
        'login_otp_send_btn': 'Send code',
        'login_otp_enter_code': 'Enter the 6-digit code we sent to your WhatsApp.',
        'login_otp_code_label': 'Verification code',
        'login_otp_verify_btn': 'Verify & log in',
        'login_otp_code_hint': 'After login we’ll suggest setting a password and saving it in your browser or password app.',
        'msg_login_otp_no_account': 'No account with this WhatsApp number. Please register first.',
        'msg_login_otp_phone_required': 'Please enter your phone number to receive the code.',
        'msg_login_otp_unavailable': 'WhatsApp login is temporarily unavailable.',
        'msg_login_otp_send_failed': 'Could not send code. Please try again or use password.',
        'msg_login_otp_invalid': 'Invalid or expired code. Please try again.',
        'msg_login_otp_sent': 'Code sent to your WhatsApp. Enter it below.',
        'msg_login_otp_success': 'Logged in. We recommend setting a password below.',
        'profile_set_password_heading': 'Set or update your password',
        'profile_set_password_suggest': 'Save your password in your browser or a password manager (e.g. phone password app) for easy, secure login next time.',
        'profile_set_password_label': 'New password (min 6 characters)',
        'profile_set_password_placeholder': '••••••••',
        'profile_set_password_btn': 'Save password',
        'msg_mail_subscribed': 'You’re subscribed to our mail service.',
        'mail_subscribe_heading': 'Mail subscription',
        'mail_subscribed_status': 'Subscribed',
        'mail_subscribed_credits': 'You get 4 extra credits every month.',
        'mail_subscribe_description': 'Subscribe to our mail service and get 4 extra credits every month.',
        'mail_subscribe_btn': 'Subscribe for +4 credits/month',
        ...
        'profile_email': 'Email',
        'profile_phone_country_code': 'Country code',
        'profile_occupation': 'Occupation',
        'profile_date_of_birth': 'Date of birth',
        'profile_nationality': 'Nationality',
        'profile_income_range': 'Income range',
        'profile_income_currency': 'Currency',
        'profile_income_section': 'Income (optional)',
        'profile_complete_banner': 'Complete your profile to earn 5 extra credits every month.',
        ...
        'successful_referrals_heading': 'Successful referrals (profile completed)',
        'successful_referrals_intro': 'People who signed up with your link and completed their profile. You received 25 credits for each.',
        'successful_referral_count_label': 'Completed profile',
        'referral_count_paid_label': 'Referrals (paid)',
        ...
        'profile_plan_starter': 'Starter',
        'profile_referral_heading': 'Referral',
        'profile_referral_intro': 'Share your link. When a friend registers and completes their first paid subscription, you get store credit.',
        'profile_referral_copy_btn': 'Copy link',
        'profile_referral_count': 'Successful referrals',
        'profile_referral_rules_title': 'Rules',
        'profile_referral_rule_1': 'Friend must register via your referral link.',
        'profile_referral_rule_2': 'When they complete their first paid subscription (monthly or annual), you get RM{amount} store credit.',
        'profile_referral_rule_3': 'Store credit can be used toward subscription.',
        'profile_referral_rule_profile_complete': 'When a referred friend completes their profile, you get 25 usage credits (one-time per friend).',
        'profile_referral_copied': 'Link copied to clipboard',
        'profile_plan_pro': 'Pro',
        'profile_plan_master': 'Master',
        'profile_plan_monthly': 'Monthly',
        'profile_plan_annual': 'Annual',
        'profile_day_master': 'Personal option',
        'profile_day_master_placeholder': '— Select —',
        'profile_day_master_hint': 'For personalized features.',
        ...
        'register_phone_label': 'WhatsApp number',
        'register_phone_placeholder': '+60 12 345 6789',
        'register_phone_hint': 'Used to receive OTP for password-free login. Enter with country code.',
        'msg_phone_required': 'Please enter a valid WhatsApp number (with country code).',
        'msg_phone_exists': 'This WhatsApp number is already registered. Use login or forgot password.',
...
'disadvantages': 'Disadvantages',
        ...
        'ai_ask_button': 'Ask',
        'ai_ask_button_with_credits': 'Ask (3 credits)',
        ...
        'pro_plan': 'Pro',
        'master_plan': 'Master',
        'starter_tagline': 'More credits for regular use',
        'pro_tagline': 'Best for power users',
        'master_tagline': 'Unlimited access',
        ...
        'contact_form_intro': 'Select the service(s) you want to enquire about, describe your request, and send a structured message to us via WhatsApp.',
        'contact_select_services': 'Services I\'m interested in',
        'contact_select_services_hint': 'Select one or more services.',
        'contact_service_change_phone': 'Change phone number',
        'contact_service_change_car_plate': 'Change car plate',
        'contact_service_read_bazi': 'Read 八字 (Ba Zi / Four Pillars)',
        'contact_service_house_fengshui': 'Check house feng shui',
        'contact_request_label': 'Your request',
        'contact_request_placeholder': 'Describe what you need (e.g. preferred dates, current number/plate, property details…)',
        'contact_name_label': 'Your name',
        'contact_name_placeholder': 'Optional',
        'contact_email_label': 'Email',
        'contact_email_placeholder': 'Optional',
        'contact_send_via_wa': 'Send via WhatsApp',
        'contact_send_hint': 'You will be taken to WhatsApp with your message ready to send to the business.',
        'contact_wa_intro': 'Hi, I would like to enquire about the following service(s).',
        'contact_wa_services': 'Services',
        'contact_wa_request': 'My request',
        'contact_wa_name': 'Name',
        'contact_wa_email': 'Email',
        ...
        'credits_free': '10 credits / month',
        'credits_starter': '150 credits / month',
        'credits_pro': '500 credits / month',
        'credits_master': 'Unlimited usage',
        ...
        'admin_topup_title': 'Top up credits',
        'admin_topup_heading': 'Top up account credits',
        'admin_topup_description': 'Add usage credits directly to a user\'s account (for number analysis, AI, lucky number). Not store balance (RM).',
        'admin_topup_email_label': 'User email',
        'admin_topup_credits_label': 'Credits to add',
        'admin_topup_btn': 'Top up',
        'admin_back': 'Back',
        'admin_topup_credits_btn': 'Top up credits',
        'admin_topup_invalid': 'Please enter a valid email and credits amount (positive number).',
        'admin_topup_user_not_found': 'User not found.',
        'admin_topup_success': 'Added {credits} credits to {email}.',
        ...
        'msg_verify_email_sent': 'Please check your email to verify your account. Then log in and complete your profile for extra credits.',
        'msg_verify_link_invalid': 'Verification link invalid or expired.',
        'msg_email_verified': 'Email verified. Complete your profile below to earn 5 extra credits per month.',
        ...
        # Lucky 4-digit page
        'lucky_page_title': 'Lucky 4-Digit Number',
        'lucky_page_subtitle': 'Generate a 4-digit lucky number.',
        'lucky_option_heading': 'Type',
        'lucky_mode_general': 'Standard',
        'lucky_mode_personal': 'Personal',
        'lucky_ready': 'Ready',
        'lucky_set_in_profile': 'Set in Profile',
        'lucky_login_to_use': 'Login to use',
        'lucky_generate_btn': 'Generate',
        'lucky_generate_btn_with_credits': 'Generate (1 credit)',
        'lucky_result_heading': 'Your lucky number',
        'lucky_credit_cost': '1 credit per generation.',
        'lucky_history_heading': 'Recent (last 10)',
        'lucky_set_day_master': 'Set your profile option in Profile to use personal.',
        'lucky_all_fav_notification': 'All 10 slots are favorites. Unfavorite one to store new numbers.',
        'lucky_fav_aria': 'Toggle favorite',
        'lucky_fav_title_add': 'Keep this number (favorite)',
        'lucky_fav_title_remove': 'Remove from favorites',
    },
    ...
    'zh': {
        ...
        # Buttons and actions
        'btn_analyze': '分析',
        'btn_analyze_with_credits': '分析 (2 积分)',
        'btn_analyzing': '分析中...',
        'btn_login': '登录',
        'forgot_password': '忘记密码？',
        'forgot_password_title': '重置密码',
        'login_tab_password': '密码登录',
        'login_tab_otp': 'WhatsApp 验证码',
        'login_otp_description': '通过 WhatsApp 收取一次性验证码，无需记住密码。',
        'login_otp_phone_label': '手机号（接收验证码）',
        'login_otp_phone_hint': '例如 +60 12 345 6789。验证码将通过 WhatsApp 发送到此号码。',
        'login_otp_send_btn': '发送验证码',
        'login_otp_enter_code': '请输入我们发送到您 WhatsApp 的 6 位数验证码。',
        'login_otp_code_label': '验证码',
        'login_otp_verify_btn': '验证并登录',
        'login_otp_code_hint': '登录后建议设置密码并保存到浏览器或手机密码应用。',
        'msg_login_otp_no_account': '此 WhatsApp 号码尚未注册，请先注册。',
        'msg_login_otp_phone_required': '请输入手机号以接收验证码。',
        'msg_login_otp_unavailable': 'WhatsApp 登录暂不可用。',
        'msg_login_otp_send_failed': '验证码发送失败，请重试或使用密码登录。',
        'msg_login_otp_invalid': '验证码无效或已过期，请重试。',
        'msg_login_otp_sent': '验证码已发送到您的 WhatsApp，请在下框输入。',
        'msg_login_otp_success': '登录成功。建议在下方设置密码。',
        'profile_set_password_heading': '设置或更新密码',
        'profile_set_password_suggest': '建议将密码保存到浏览器或密码管理器（如手机密码应用），下次登录更安全便捷。',
        'profile_set_password_label': '新密码（至少 6 位）',
        'profile_set_password_placeholder': '••••••••',
        'profile_set_password_btn': '保存密码',
        'msg_mail_subscribed': '您已订阅我们的邮件服务。',
        'mail_subscribe_heading': '邮件订阅',
        'mail_subscribed_status': '已订阅',
        'mail_subscribed_credits': '每月可额外获得 4 积分。',
        'mail_subscribe_description': '订阅我们的邮件服务，每月额外获得 4 积分。',
        'mail_subscribe_btn': '订阅即享每月 +4 积分',
        ...
        'profile_phone': '电话号码',
        'profile_email': '邮箱',
        'profile_phone_country_code': '国家/地区代码',
        'profile_occupation': '职业',
        'profile_date_of_birth': '出生日期',
        'profile_nationality': '国籍',
        'profile_income_range': '收入范围',
        'profile_income_currency': '货币',
        'profile_income_section': '收入（选填）',
        'profile_complete_banner': '完成个人资料，每月可多获 5 积分。',
        'profile_save': '保存',
        'currency_USD': '美元 USD',
        'currency_SGD': '新元 S$',
        'currency_TWD': '新台币 TWD',
        'currency_RMB': '人民币 RMB',
        'currency_RM': '马币 RM',
        'currency_OTHER': '其他',
        'successful_referrals_heading': '成功推荐（已填资料）',
        'successful_referrals_intro': '通过您的链接注册并完成个人资料的好友。您已为每位获得 25 积分。',
        'successful_referral_count_label': '已填资料',
        'referral_count_paid_label': '推荐（已付费）',
        'profile_credits_title': '积分与计划',
        'profile_usage_balance': '可用积分',
        'profile_plan': '计划',
        'profile_store_balance': '余额 (RM)',
        'profile_plan_free': '免费',
        'profile_plan_starter': '入门版',
        'profile_referral_heading': '推荐好友',
        'profile_referral_intro': '好友通过您的链接注册并完成首次付费订阅后，您将获得余额，可用于抵扣订阅。',
        'profile_referral_copy_btn': '复制链接',
        'profile_referral_count': '成功推荐人数',
        'profile_referral_rules_title': '规则说明',
        'profile_referral_rule_1': '好友须通过您的推荐链接注册。',
        'profile_referral_rule_2': '好友完成首次付费订阅（月付或年付）后，您将获得 RM{amount} 余额。',
        'profile_referral_rule_3': '余额可用于抵扣订阅费用。',
        'profile_referral_rule_profile_complete': '好友完成个人资料后，您将获得 25 积分（每位仅一次）。',
        'profile_referral_copied': '链接已复制到剪贴板',
        'profile_plan_pro': '专业版',
        'profile_plan_master': '大师版',
        'profile_plan_monthly': '月付',
        'profile_plan_annual': '年付',
        'profile_day_master': '个人选项',
        'profile_day_master_placeholder': '— 选择 —',
        'profile_day_master_hint': '用于个性化功能。',
        'btn_subscribe': '订阅',
        ...
        'register_phone_label': 'WhatsApp 号码',
        'register_phone_placeholder': '+60 12 345 6789',
        'register_phone_hint': '用于接收验证码，免密码登录。请包含国家/地区代码。',
        'msg_phone_required': '请输入有效的 WhatsApp 号码（含国家/地区代码）。',
        'msg_phone_exists': '此 WhatsApp 号码已注册，请直接登录或使用忘记密码。',
...
'disadvantages': '缺点',
        ...
        'ai_ask_button': '提问',
        'ai_ask_button_with_credits': '提问 (3 积分)',
        'ai_ask_asking': '正在提问...',
        ...
        'contact_form_intro': '选择您想咨询的服务，填写您的需求，将通过 WhatsApp 发送结构化讯息给我们。',
        'contact_select_services': '我想咨询的服务',
        'contact_select_services_hint': '可多选。',
        'contact_service_change_phone': '更换手机号码',
        'contact_service_change_car_plate': '更换车牌',
        'contact_service_read_bazi': '看八字',
        'contact_service_house_fengshui': '看家居风水',
        'contact_request_label': '您的需求说明',
        'contact_request_placeholder': '请描述您的需求（例如：希望日期、现有号码/车牌、房屋资料等）',
        'contact_name_label': '您的姓名',
        'contact_name_placeholder': '选填',
        'contact_email_label': '电子邮箱',
        'contact_email_placeholder': '选填',
        'contact_send_via_wa': '通过 WhatsApp 发送',
        'contact_send_hint': '将跳转到 WhatsApp，讯息已填好，可直接发送给客服。',
        'contact_wa_intro': '您好，我想咨询以下服务。',
        'contact_wa_services': '服务项目',
        'contact_wa_request': '我的需求',
        'contact_wa_name': '姓名',
        'contact_wa_email': '邮箱',
        ...
        'credits_free': '10 积分/月',
        'credits_starter': '150 积分/月',
        'credits_pro': '500 积分/月',
        'credits_master': '无限使用',
        'unlimited_usage': '无限',
        ...
        'admin_topup_title': '充值积分',
        'admin_topup_heading': '为用户充值积分',
        'admin_topup_description': '直接增加用户账户的可用积分（用于数字分析、AI、幸运数字等）。非余额（RM）。',
        'admin_topup_email_label': '用户邮箱',
        'admin_topup_credits_label': '充值积分数量',
        'admin_topup_btn': '充值',
        'admin_back': '返回',
        'admin_topup_credits_btn': '充值积分',
        'admin_topup_invalid': '请输入有效邮箱和正数积分。',
        'admin_topup_user_not_found': '用户不存在。',
        'admin_topup_success': '已为 {email} 增加 {credits} 积分。',
        'msg_invalid_subscription': '无效的订阅类型',
        'msg_user_exists': '用户已存在',
        'msg_email_password_required': '请输入邮箱和密码',
        'msg_register_success': '注册成功，请登录',
        'msg_verify_email_sent': '请查收邮件验证您的账号。验证后登录并完成个人资料即可获得额外积分。',
        'msg_verify_link_invalid': '验证链接无效或已过期。',
        'msg_email_verified': '邮箱已验证。请在下文完成个人资料，每月可多获 5 积分。',
        ...
        # Lucky 4-digit page
        'lucky_page_title': '幸运四位数',
        'lucky_page_subtitle': '生成四位幸运数字。',
        'lucky_option_heading': '类型',
        'lucky_mode_general': '标准',
        'lucky_mode_personal': '个人',
        'lucky_ready': '已设置',
        'lucky_set_in_profile': '请在个人资料中设置',
        'lucky_login_to_use': '登录后可用',
        'lucky_generate_btn': '生成',
        'lucky_generate_btn_with_credits': '生成 (1 积分)',
        'lucky_result_heading': '您的幸运数字',
        'lucky_credit_cost': '每次生成消耗 1 积分。',
        'lucky_history_heading': '最近 10 条',
        'lucky_set_day_master': '请在个人资料中设置后再使用个人选项。',
        'lucky_all_fav_notification': '10 个位置已全部设为收藏。取消一个收藏后才能保存新数字。',
        'lucky_fav_aria': '切换收藏',
        'lucky_fav_title_add': '收藏此数字',
        'lucky_fav_title_remove': '取消收藏',
    }
}
